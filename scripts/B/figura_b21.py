"""
Figura B.21 â€” Accesos del Servicio de TelevisiÃ³n Restringida Residencial
...
GeometrÃ­a de estados requerida (descargar una sola vez):
...
4. Merge por nombre de estado â†’ penetraciÃ³n = accesos / hogares * 100
5. Unir con GeoJSON â†’ mapa coroplÃ©tico con 5 rangos de color

ValidaciÃ³n (valores exactos del Anuario IFT 2024)
--------------------------------------------------
QuerÃ©taro : 94   Sonora : 80   Sinaloa : 76
YucatÃ¡n   : 42   Oaxaca : 38   Chiapas : 35
Nacional  : 58
"""
...
ENT_MAP = {
    ...
    15: 'MÃ©xico',                 16: 'MichoacÃ¡n de Ocampo',
...
por_entidad = por_entidad[por_entidad['ENTIDAD'] != 'Sin informaciÃ³n de Entidad']
...
print("\nâ”€â”€ ValidaciÃ³n â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€")
for estado, esperado in [('QuerÃ©taro', 94), ('Sonora', 80), ('Sinaloa', 76),
                          ('YucatÃ¡n', 42), ('Oaxaca', 38), ('Chiapas', 35)]:
...
RANGOS = [
    ...
    (75, 85, '#F4A07A', '76-85'),          # salmÃ³n
    (85, 200,'#D94F3D', 'MÃ¡s de 85'),      # rojo
]
...
# Título
ax.set_title(
    'Figura B.21. Accesos del Servicio de TelevisiÃ³n Restringida\n'
