...
años    = df_anual['ANIO'].values
valores = df_anual['TRAF_M'].values

# 3. Graficar
fig, ax = plt.subplots(figsize=(14, 6))

ax.plot(años, valores, color='#2E5F8A', linewidth=2, marker='o', markersize=5,
        zorder=3, label='Tráfico local del servicio fijo de telefonía')
ax.fill_between(años, valores, alpha=0.12, color='#2E5F8A')
...
ax.set_title('Figura B.8. Tráfico de minutos del Servicio Fijo de Telefonía (2000-2023)',
...
print("\nValores calculados (minutos acumulados por año):")
